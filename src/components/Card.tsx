...
const Card = ({ title, principalPrice, secondaryPrice }: CardProps) => {
  return (
    <div className="flex flex-row justify-between items-center w-full lg:w-11/12 h-40 2xl:h-56 bg-black bg-opacity-90 p-5 lg:p-8">
      ...
      <div className="flex flex-col justify-center items-center font-semibold">
        <span
          className={
            (principalPrice.length > 8 ? "text-3xl" : "text-4xl") +
            " 2xl:text-5xl text-white"
          }
        >
          {principalPrice}
        </span>
